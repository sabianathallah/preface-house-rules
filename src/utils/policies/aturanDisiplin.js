export const aturanDisiplinPolicies = [
  {
    id: 10,
    category: "Aturan Disiplin",
    categoryColor: "#dc2626",
    title: "Peraturan Disiplin & Sanksi",
...
Kami mengkategorikan pelanggaran berdasarkan dampaknya untuk memberikan kejelasan mengenai batasan yang perlu dijaga.

#### **A. Pelanggaran Ringan**
*Pelanggaran yang dapat terjadi pada siapa saja namun perlu diingatkan*

**Kehadiran & Ketepatan Waktu**
- **Keterlambatan sesekali** (1-3 kali per bulan) tanpa pemberitahuan
- **Lupa melakukan absensi** atau tidak mengisi timesheet
- **Tidak menghadiri meeting mendadak** tanpa pemberitahuan
- **Pulang lebih awal** tanpa konfirmasi kepada atasan
- **Break time melebihi durasi** yang ditentukan (lebih dari 60 menit)

**Kerapihan & Sikap Kerja**
- **Berpakaian terlalu kasual** yang tidak sesuai (sandal, pakaian tidak layak)
- **Area kerja tidak rapi** yang mengganggu kenyamanan bersama
- **Penggunaan ponsel berlebihan** untuk urusan pribadi saat jam kerja
- **Menimbulkan kebisingan** yang mengganggu konsentrasi rekan kerja
- **Tidak menjaga kebersihan** area bersama seperti pantry

**Administrasi**
- **Terlambat submit laporan** kerja atau timesheet (3-5 hari)
- **Tidak mengikuti prosedur** pengajuan izin atau cuti dengan benar
- **Kehilangan ID card** atau akses card perusahaan

**Pendekatan:**
- Percakapan informal dengan atasan untuk memahami kendala
- Pengingat yang bersifat membina, bukan memarahi
- Tidak masuk dalam catatan formal (kecuali menjadi kebiasaan berulang)
- Fokus pada pemahaman dan bantuan untuk perbaikan

---

#### **B. Pelanggaran Sedang**
*Pelanggaran yang mulai mengganggu tim atau produktivitas dan perlu tindakan korektif*

**Kehadiran & Kinerja**
- **Absen tanpa pemberitahuan** (alpha) selama 1-2 hari
- **Keterlambatan berulang** (lebih dari 5 kali per bulan) tanpa alasan jelas
- **Tidak menyelesaikan deadline** berulang kali tanpa komunikasi proaktif
- **Menolak tugas** dari atasan tanpa alasan yang valid
- **Meninggalkan kantor saat jam kerja** tanpa izin

**Komunikasi & Perilaku**
- **Komunikasi dengan nada kasar** atau tidak menghormati rekan kerja
- **Menyebarkan rumor atau informasi** yang belum dikonfirmasi kebenarannya
- **Menggunakan bahasa tidak profesional** dalam komunikasi resmi atau dengan klien
- **Tidak kooperatif** dalam kerja sama tim
- **Mengeluh berlebihan** yang menurunkan morale tim

**Penggunaan Aset**
- **Menggunakan internet kantor** untuk aktivitas non-produktif secara berlebihan
- **Mengunduh konten ilegal** menggunakan jaringan perusahaan
- **Menggunakan software tidak berlisensi** tanpa izin dari IT
- **Menggunakan aset perusahaan** untuk kepentingan pribadi tanpa izin

**Pendekatan:**
- Meeting one-on-one untuk mengidentifikasi akar masalah
- Teguran tertulis melalui email atau memo
- Performance Improvement Plan jika diperlukan
- Masuk dalam catatan untuk keperluan tracking
- Tujuan: membantu karyawan kembali ke performa terbaik

---

#### **C. Pelanggaran Berat**
*Pelanggaran serius yang melampaui batas toleransi dan memerlukan konsekuensi tegas*
...
- **Pencurian** aset atau dana perusahaan
- **Pemalsuan dokumen** resmi (surat, invoice, kontrak, laporan)
- **Fraud atau korupsi** dalam bentuk apapun

**Kerahasiaan & Data**
- **Membocorkan rahasia perusahaan** kepada pihak eksternal
- **Menjual atau menyalahgunakan data** pelanggan atau informasi sensitif
- **Mengakses sistem tanpa otorisasi** (akses tidak sah ke database)
- **Membawa dokumen rahasia keluar** tanpa izin resmi

**Konflik Kepentingan Serius**
- **Bekerja untuk kompetitor** tanpa disclosure dan persetujuan
- **Menerima suap atau kickback** dari vendor atau klien
- **Menyalahgunakan posisi** untuk keuntungan pribadi yang merugikan perusahaan
- **Menjalankan bisnis sampingan** yang secara langsung merugikan Preface

**Kehadiran & Loyalitas**
- **Absen lebih dari 3 hari berturut-turut** tanpa pemberitahuan sama sekali
- **Resign mendadak** tanpa menjalani notice period yang disepakati
- **Menghasut karyawan lain** untuk melakukan tindakan yang merugikan perusahaan
- **Sabotase** terhadap sistem, project, atau operasional perusahaan

**Catatan:**
Untuk pelanggaran berat, investigasi tetap dilakukan secara fair dan menyeluruh, namun konsekuensinya akan lebih serius mengingat dampaknya terhadap perusahaan dan seluruh karyawan.
...
#### **Level 1: Verbal Warning (Teguran Lisan)** 💬
...
#### **Level 2: Written Warning (Teguran Tertulis)** 📧
...
#### **Level 4: Surat Peringatan 2 (SP2)**
...
#### **Level 5: Surat Peringatan 3 (SP3)**
- **Untuk:** Tidak ada perbaikan setelah SP2 atau pelanggaran sangat berat
- **Proses:**
  - Meeting dengan Direksi, HR, dan Atasan
  - Penyusunan Final Performance Improvement Plan dengan target sangat spesifik
  - Status "under final probation"
  - Diskusi mengenai kesesuaian dengan perusahaan
- **Dokumentasi:** File permanent dengan status peringatan akhir
- **Masa Berlaku:** 12 bulan
- **Dampak:**
  - KPI dikurangi 30-40%
  - Freeze total untuk kenaikan gaji, bonus, dan promosi
  - Evaluasi setiap 2 minggu dengan laporan detail
  - Satu pelanggaran tambahan dapat mengakibatkan PHK
...
- **Untuk:**
  ...
  - Tidak ada perbaikan sama sekali setelah SP3
...
- **Jenis PHK:**
  - **Dengan pesangon**: Untuk pelanggaran sedang-berat setelah melalui tahapan SP3
...
📞 **HR Hotline**: 0812-3456-7890 (jam kerja)
